...
namespace Data.Functions.CRUD
{
    public class CRUD : ICRUD
    {
        ...
        /// <returns></returns>
        public async Task<T> Read<T>(string entityId) where T : class
        {
            try
            {
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public async Task<T> Update<T>(T objectToUpdate, string entityId) where T : class
        {
            try
            {
                using (var context = new DatabaseContext(DatabaseContext.Options.DatabaseOptions))
        ...
        /// <param name="entityId"></param>
        /// <returns></returns>
        public async Task<bool> Delete<T>(string entityId) where T : class
        {
            try
            {
                using (DatabaseContext context = new DatabaseContext(DatabaseContext.Options.DatabaseOptions))
